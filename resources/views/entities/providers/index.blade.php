        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl sm:mx-auto">
                    ...
                    <!-- Filter form -->
                    <form action="{{route('providers.index')}}" class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                        @csrf
                        <div class="order-2 flex flex-col items-center sm:order-1 sm:block">
                            <!-- Search input -->
                            <x-input-label for="search" :value="__('Buscar Proveedor:')" />
                            <x-text-input id="search" name="search" value="{{$search ?? null}}" placeholder="..." class="mb-2" />
                            <div>
                                <!-- Send button -->
                                ...
                                <!-- Clear Button -->
                                <x-secondary-link-button href="{{route('providers.index')}}" class="bg-red-400 hover:bg-red-600 text-white">
                                    X
