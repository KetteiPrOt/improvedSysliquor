...
@if(count($products) > 0)
    <span id="productsCount" class="hidden">{{count($products)}}</span>
        ...
        <tbody class="bg-white dark:bg-slate-800" id="selectedProductsTableBody">
            ...
            @if($products)
                ...
                <tr>
                    ...
                    <td class="block lg:table-cell text-lg sm:text-sm text-center lg:text-left font-bold sm:font-medium border-b border-slate-100 dark:border-slate-700 p-2 sm:pr-4 pl-2 sm:pl-8 text-slate-500 dark:text-slate-400">
